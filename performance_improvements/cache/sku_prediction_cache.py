...
class SKUPredictionCache:
    ...
    def __init__(self, max_memory_cache=1000, cache_db_path="performance_improvements/cache/prediction_cache.db"):
...
def initialize_cache(max_memory_cache=1000, cache_db_path="performance_improvements/cache/prediction_cache.db"):
